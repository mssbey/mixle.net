...
export function WhatsAppFab({ alwaysVisible = false, href = '/iletisim' }: { alwaysVisible?: boolean; href?: string }) {
    ...
    <AnimatePresence>
      {(show || alwaysVisible) && (
        <m.a
          ...
          style={{ height: alwaysVisible ? 68 : 52, width: alwaysVisible ? 68 : 52, ...(alwaysVisible ? { backgroundColor: '#19ce60' } : {}) }}
        >
